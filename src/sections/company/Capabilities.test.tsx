...
describe('Capabilities', () => {
  it('shows the five approved capability families and complete-system flow', () => {
    render(<Capabilities />);
    ...
    expect(screen.getByRole('heading', { name: 'Autonomous Systems & Drone Robotics' })).toBeVisible();
    expect(screen.getByRole('link', { name: 'View capability' })).toHaveAttribute('href', '/autonomous-systems/');
